...
a = random.multivariate_normal(cnb.KEYS[0], mu_a, cov_a, shape=(pts,))
...
b = random.multivariate_normal(cnb.KEYS[1], mu_b, cov_b, shape=(pts,))
# combined points
...
def test_kmeans1():
    ...
    result = vq.kmeans_jit(cnb.KEYS[3], features, k)
